    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <a href="/verify" className="hidden md:block">
              ...
              <SheetContent side="right" className="w-full max-w-sm">
                <div className="flex flex-col h-full">
                  ...
                  <nav className="flex flex-col gap-6 py-6">
                    ...
                    <a href="/dashboard" onClick={() => setIsMenuOpen(false)} className="text-lg font-medium text-primary">
                      Dashboard
                    </a>
                    <a href="/verify" onClick={() => setIsMenuOpen(false)} className="text-lg font-medium text-foreground hover:text-primary transition-colors">
                      Verify
                    </a>
                  </nav>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground text-base sm:text-lg">Real-time fact verification and crisis information monitoring</p>
        </div>
        ...
        <Tabs defaultValue="all" className="w-full">
                    ...
                    <div className="flex flex-col sm:flex-row items-start justify-between">
                      <div className="flex-1 mb-4 sm:mb-0">
                        <div className="flex items-center gap-3 mb-2">
                          <div className={`w-3 h-3 rounded-full ${getPriorityColor(crisis.priority)} flex-shrink-0`} />
                          <CardTitle className="text-lg sm:text-xl font-bold text-card-foreground">{crisis.title}</CardTitle>
                        </div>
                         <Badge className={`${getStatusColor(crisis.status)} flex items-center gap-1 mb-3 w-max`}>
                  ...
                  <CardContent>
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                      ...
                      <div className="flex gap-2 mt-4 sm:mt-0 w-full sm:w-auto">
                        ...
                        <Button size="sm" className="w-full sm:w-auto bg-primary hover:bg-primary/90">Verify Claims</Button>
                      </div>
                    </div>
                  </CardContent>
                </Card>
          ...
          {/* Note: The content for other tabs would be similarly structured and filtered. */}
          <TabsContent value="verified" className="mt-6">
             <p className="text-center text-muted-foreground">Verified crises would be listed here.</p>
          </TabsContent>
          <TabsContent value="disputed" className="mt-6">
             <p className="text-center text-muted-foreground">Disputed crises would be listed here.</p>
          </TabsContent>
          <TabsContent value="unverified" className="mt-6">
             <p className="text-center text-muted-foreground">Pending crises would be listed here.</p>
          </TabsContent>
        </Tabs>
      </div>
    </div>
